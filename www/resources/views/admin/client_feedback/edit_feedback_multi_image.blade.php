        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-5">Update Feedback Multi Image</h4>
                            <form method="post" action="{{route('update.feedback.multi.image')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <input type="submit" class="btn btn-info waves-effect waves-light mt-5"
                                       value="Update Feedback Multi Image">
                            </form>
                        </div>
                    </div>
                </div>
